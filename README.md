...
Crossplane Provider for HTTP requests as resources<br>
<img src="https://img.shields.io/badge/Go-00ADD8?style=flat-square&logo=go&logoColor=fff" alt="Go">
...
Declarative GitOps CD for Kubernetes<br>
<img src="https://img.shields.io/badge/Go-00ADD8?style=flat-square&logo=go&logoColor=fff" alt="Go">
...
OpenTelemetry Helm Charts<br>
<img src="https://img.shields.io/badge/Helm-0F1689?style=flat-square&logo=helm&logoColor=fff" alt="Helm">
...
SDK for building Kubernetes APIs<br>
<img src="https://img.shields.io/badge/Go-00ADD8?style=flat-square&logo=go&logoColor=fff" alt="Go">
...
Barman Cloud plugin for CloudNativePG<br>
<img src="https://img.shields.io/badge/Go-00ADD8?style=flat-square&logo=go&logoColor=fff" alt="Go">
...
Creates etcd backups and uploads them to AWS S3<br>
<img src="https://img.shields.io/badge/Go-00ADD8?style=flat-square&logo=go&logoColor=fff" alt="Go">
...
Preconfigured learning environment for GitOps with Kubernetes & Argo CD<br>
...
Preconfigured Strimzi Kafka environment for Kubernetes<br>
<img src="https://img.shields.io/badge/Shell-4EAA25?style=flat-square&logo=gnubash&logoColor=fff" alt="Shell">
...
Access other storage backends via the S3 API<br>
...
Distributed temporal graph analytics on Apache Flink with pattern matching and graph mining<br>
<img src="https://img.shields.io/badge/Java-ED8B00?style=flat-square&logo=openjdk&logoColor=fff" alt="Java">
...
Collection of open source Kafka Connect connectors for S3, Cassandra, Elasticsearch, MongoDB and more<br>
<img src="https://img.shields.io/badge/Scala-DC322F?style=flat-square&logo=scala&logoColor=fff" alt="Scala">
...
Python library to create AWS CloudFormation descriptions<br>
...
Accompanies a series of blogposts about Kubernetes on AWS<br>
<img src="https://img.shields.io/badge/Terraform-844FBA?style=flat-square&logo=terraform&logoColor=fff" alt="Terraform">
...
Quickstart to set up applications on AWS ECS with Fargate Spot using Terraform<br>
<img src="https://img.shields.io/badge/Terraform-844FBA?style=flat-square&logo=terraform&logoColor=fff" alt="Terraform">
...
A Claude Code skill to delegate prompts to Codex<br>
<img src="https://img.shields.io/badge/Markdown-000?style=flat-square&logo=markdown&logoColor=fff" alt="Markdown">
...
Python SDK & Proxy Server to call 100+ LLM APIs<br>
<img src="https://img.shields.io/badge/Python-3776AB?style=flat-square&logo=python&logoColor=fff" alt="Python">
...
Agentic AI framework based on Apache Flink<br>
<img src="https://img.shields.io/badge/Java-ED8B00?style=flat-square&logo=openjdk&logoColor=fff" alt="Java">
...
Voice-to-text app for macOS with near-instant local transcription and screen context awareness<br>
...
Model Context Protocol server for GitLab, enabling AI agents to interact with GitLab APIs<br>
<img src="https://img.shields.io/badge/TypeScript-3178C6?style=flat-square&logo=typescript&logoColor=fff" alt="TypeScript">
...
Instant realtime GraphQL APIs on Postgres, SQL Server, BigQuery and MongoDB with fine grained access control<br>
<img src="https://img.shields.io/badge/TypeScript-3178C6?style=flat-square&logo=typescript&logoColor=fff" alt="TypeScript">
